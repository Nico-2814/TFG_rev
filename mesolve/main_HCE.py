...
#Dynamics
from definitions_HCE import timestamps, K1, K2, N_c, N_Q, max_step, hbar

#Loading matrices
H = Qobj(np.loadtxt("hamiltonian.txt")).to("csr")
rho_0 = Qobj(np.load("HCE.npy"))
...
ops = rhos_list+[Q2op1, Q2op2, distance_to_HCE, entropy_fun, purity, saver]
...
qsave(Time_Evolution.final_state, "final_state")

with h5py.File("results/h_1_for_real_HCE.h5", "w") as f:
